...
const ProductDetail = () => {
    ...
    <CustomerLayout>
      <div className="container mx-auto px-4 py-8 animate-pulse">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4"><div className="h-8 w-3/4 bg-muted rounded" /><div className="h-5 w-1/3 bg-muted rounded" /><div className="h-4 w-full bg-muted rounded" /><div className="h-12 w-40 bg-muted rounded-lg mt-6" /></div>
        </div>
      </div>
    </CustomerLayout>
  );
  ...
  const productSchema = {
    ...
    "offers": {
      ...
      "seller": { "@type": "Organization", "name": siteSettings.store_name || "AI Laptop Wala", "url": siteSettings.site_url || "" },
