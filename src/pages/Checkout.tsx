          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div><Label className="text-sm">First Name</Label><Input placeholder="Prachi" className="mt-1" /></div>
                <div><Label className="text-sm">Last Name</Label><Input placeholder="Sharma" className="mt-1" /></div>
              </div>
              <div><Label className="text-sm">Email</Label><Input type="email" placeholder="prachi@email.com" className="mt-1" /></div>
              <div><Label className="text-sm">Mobile Number</Label><Input placeholder="+91 98765 43210" className="mt-1" /></div>
