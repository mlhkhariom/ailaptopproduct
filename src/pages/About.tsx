...
const values = [
  ...
  { icon: Target, title: "Research-Backed", desc: "Ancient Ayurvedic wisdom validated by modern scientific research." },
];

const team = [
  { name: "Dr. Prachi", role: "Founder & Ayurvedic Physician", avatar: "DP", desc: "15+ years of experience in Ayurvedic medicine and homeopathy." },
  { name: "Vaidya Meera Joshi", role: "Head of Formulations", avatar: "MJ", desc: "Specializes in classical Ayurvedic formulations and herbal research." },
  ...
  <CustomerLayout>
    <section className="bg-gradient-to-br from-primary/5 via-background to-accent/10 py-16">
      <div className="container mx-auto px-4 text-center max-w-3xl">
        ...
        <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">About Apsoncure PHC</h1>
        <p className="text-lg text-muted-foreground leading-relaxed">
          Apsoncure is a trusted brand by Prachi Homeo Clinic, dedicated to bringing authentic Ayurvedic and homeopathic wellness solutions to every Indian household. We believe that nature holds the cure — and our mission is to make it accessible, affordable, and effective.
        </p>
      </div>
    </section>
    ...
    <section className="py-12 bg-primary/5 text-center">
      <div className="container mx-auto px-4">
        ...
        <p className="text-muted-foreground mb-6">Browse our products or talk to Dr. Prachi for free consultation.</p>
