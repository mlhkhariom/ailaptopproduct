    ...
    <CustomerLayout>
      <article className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground mb-6">
          ...
          <span className="flex items-center gap-1"><Calendar className="h-4 w-4" />{new Date(post.date).toLocaleDateString("en-IN", { month: "long", day: "numeric", year: "numeric" })}</span>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Ayurveda, the "Science of Life," has been guiding humanity towards optimal health for over 5,000 years. 
            In today's fast-paced world, the ancient wisdom of Ayurveda offers practical solutions for modern health challenges.
          </p>
          <h2 className="text-2xl font-serif font-bold mt-8 mb-4">The Foundation of Balance</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
            At the core of Ayurvedic philosophy lies the concept of balance — between the mind, body, and spirit. 
            When these elements are in harmony, we experience vibrant health and vitality. When they are disrupted, 
            disease and discomfort follow.
          </p>
          <h2 className="text-2xl font-serif font-bold mt-8 mb-4">Practical Tips for Daily Life</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
            Start your morning with warm water and a squeeze of lemon. Practice oil pulling with sesame or coconut oil. 
            Eat your largest meal at midday when your digestive fire (Agni) is strongest. Wind down in the evening 
            with calming herbs like Ashwagandha or Brahmi.
          </p>
        </div>
