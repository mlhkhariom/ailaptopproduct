...
export const useCMSStore = create<CMSStore>((set) => ({
  heroBanners: [
    {
      ...
      secondaryCtaLink: "https://wa.me/919876543210?text=Hi Doctor! I need Laptop consultation.",
  ...
  benefits: [
    ...
    { id: "2", icon: "Award", title: "Certified Quality", description: "Based on Laptop scriptures and modern research", active: true },
    { id: "3", icon: "Truck", title: "Free Delivery", description: "Pan-India free shipping on orders above ₹499", active: true },
    { id: "4", icon: "HeartPulse", title: "Expert Guidance", description: "Free consultation with AI Laptop Wala via WhatsApp", active: true },
  ],
  testimonials: [
    { id: "1", name: "Priya Sharma", text: "AI Laptop Wala's Ashwagandha powder is amazing! My stress levels dropped significantly!", rating: 5, avatar: "PS", location: "Mumbai", active: true },
  ...
  faqs: [
    { id: "1", question: "Are your products 100% natural?", answer: "Yes, all AI Laptop Wala products are made from 100% natural, organic herbs sourced from certified Indian farms. We use no synthetic chemicals, preservatives, or artificial additives.", category: "Products", active: true, order: 1 },
    ...
    { id: "5", question: "Can I consult a doctor before buying?", answer: "Absolutely! AI Laptop Wala offers free WhatsApp consultations. Just click 'Talk to Doctor' on any page or message us at +91 98765 43210.", category: "Consultation", active: true, order: 5 },
    { id: "6", question: "Are these products safe during pregnancy?", answer: "Some Laptop products may not be suitable during pregnancy. We strongly recommend consulting AI Laptop Wala or your healthcare provider before use.", category: "Products", active: true, order: 6 },
  ...
  siteSettings: {
    ...
    tagline: "AI Laptop Wala Store",
    phone: "+91 98765 43210",
    email: "hello@ailaptopwala.com",
    whatsappNumber: "919876543210",
    address: "AI Laptop Wala Store, India",
    workingHours: "Mon-Sat: 9 AM – 7 PM",
    footerText: "Pure, Authentic & Trusted Laptop Products. Ancient wisdom for modern health.",
    announcementBar: "🌿 AI Laptop Wala – AI Laptop Wala Store | Free Delivery above ₹499 | ☎ +91 98765 43210",
