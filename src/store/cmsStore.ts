...
export const useCMSStore = create<CMSStore>((set) => ({
  ...
  faqs: [
    ...
    { id: "8", question: "Where is your store located?", answer: "LG-21, B-Block, Silver Mall, RNT Marg, Indore, MP – 452001. Open Mon-Sat 10AM-8PM. Call: +91 98934 96163.", category: "Store", active: true, order: 8 },
  ],
  siteSettings: {
